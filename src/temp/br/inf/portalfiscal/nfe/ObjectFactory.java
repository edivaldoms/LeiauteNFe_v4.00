...
public class ObjectFactory {
    ...
    private final static QName _TNFeInfNFeDetProdPCredPresumido_QNAME = new QName("http://www.portalfiscal.inf.br/nfe", "pCredPresumido");
    private final static QName _TNFeInfNFeDetProdVCredPresumido_QNAME = new QName("http://www.portalfiscal.inf.br/nfe", "vCredPresumido");
    private final static QName _TNFeInfNFeDetProdCCredPresumido_QNAME = new QName("http://www.portalfiscal.inf.br/nfe", "cCredPresumido");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/nfe", name = "pCredPresumido", scope = TNFe.InfNFe.Det.Prod.class)
    public JAXBElement<String> createTNFeInfNFeDetProdPCredPresumido(String value) {
        return new JAXBElement<String>(_TNFeInfNFeDetProdPCredPresumido_QNAME, String.class, TNFe.InfNFe.Det.Prod.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/nfe", name = "vCredPresumido", scope = TNFe.InfNFe.Det.Prod.class)
    public JAXBElement<String> createTNFeInfNFeDetProdVCredPresumido(String value) {
        return new JAXBElement<String>(_TNFeInfNFeDetProdVCredPresumido_QNAME, String.class, TNFe.InfNFe.Det.Prod.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/nfe", name = "cCredPresumido", scope = TNFe.InfNFe.Det.Prod.class)
    public JAXBElement<String> createTNFeInfNFeDetProdCCredPresumido(String value) {
        return new JAXBElement<String>(_TNFeInfNFeDetProdCCredPresumido_QNAME, String.class, TNFe.InfNFe.Det.Prod.class, value);
    }
